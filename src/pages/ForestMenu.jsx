...
const ForestMenu = () => {
  ...
  return (
    <div style={{
      ...
      <button
        onClick={() => navigate('/oyun/hafta-1-fark-et')}
      ...
      <button
        onClick={() => navigate('/oyun/hafta-2-hisset')}
      ...
      <button
        onClick={() => navigate('/oyun/hafta-3-hareket-ettir')}
      ...
      <button
        onClick={() => navigate('/oyun/hafta-4-kontrol-et')}
      ...
      <button
        onClick={() => navigate('/oyun/hafta-5-surdur')}
      ...
      <button
        onClick={() => navigate('/oyun/hafta-6-guc-uret')}
      ...
      <button
        onClick={() => navigate('/oyun/hafta-7-birlestir')}
      ...
      <button
        onClick={() => navigate('/oyun/hafta-8-aktar')}
